...
namespace CaptchaLib
{
  public static class HtmlHelperExtensions
  {
       ...
       object routeValues, string refreshLabel, object htmlAttributes)
    {
      ...
      //image.MergeAttribute("class", "col-md-4 control-label");
      image.MergeAttribute("border", "0");
      image.MergeAttribute("width", "90");
      image.MergeAttribute("height", "34");
      ...
      /*var rightDiv = new TagBuilder("div");
      rightDiv.MergeAttribute("class", "col-md-10");
      var textBox = htmlHelper.TextBox(name, "", new { @class = "form-control" });
      rightDiv.InnerHtml += textBox;
      container.InnerHtml += rightDiv;*/
